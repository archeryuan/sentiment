package hunt.social.sentiment;

import java.util.regex.Matcher;
import java.util.regex.Pattern;

public class SentimentUtil {
	public static float getSentimentScore(String content) {
		if (CLibrarySentiment.Instance.ST_Init("/home/hb/nlpData/", 1, "") == 0) {
...
//			System.out.println("初始化成功");
		...
		String sentimentScoreStr = CLibrarySentiment.Instance.ST_GetSentencePoint(content);

//		System.out.println(sentimentScoreStr);
		Pattern pattern = Pattern.compile(".*<polarity>(.*)</polarity>.*");
		Matcher matcher = pattern.matcher(sentimentScoreStr);
		float score = 0;
		if(matcher.find()){
	...
	public static void main(String[] a){
		...
		String con1 = "非常非常差";
		String con2 = "非常非常满意";	
		System.out.println(getSentimentScore(sContent));
		
		System.out.println(getSentimentScore(con1));
		
		System.out.println(getSentimentScore(con2));
